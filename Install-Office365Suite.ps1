...
param(
  ...
  [Parameter(ParameterSetName = 'NoXML')][ValidateSet('Groove', 'Outlook', 'OneNote', 'Access','OneDrive', 'Publisher', 'Lync', 'Word', 'Excel', 'PowerPoint', 'Teams')][Array]$ExcludeApps=('Groove', 'Outlook', 'OneNote', 'Access','OneDrive', 'Publisher', 'Lync'),
  [Parameter(ParameterSetName = 'NoXML')][ValidateSet('64', '32')]$OfficeArch = '64',
  [Parameter(ParameterSetName = 'NoXML')][ValidateSet('O365BusinessRetail')]$OfficeEdition = 'O365BusinessRetail',
  ...
  [String]$OfficeInstallDownloadPath = 'C:\Office365Install',
